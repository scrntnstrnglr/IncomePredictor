...
def main():
    ...
    parser.add_argument('--trainingdata', help='Absolute path of training data', type=str)
    parser.add_argument('--predictiondata', help='Absolute path of prediction data', type=str)
    parser.add_argument('--outputfile', help='Existing output file with serial numbers and without predictions', type=str)
    args = parser.parse_args()

    print("Importing Training data set : "+args.trainingdata)
    data=pd.read_csv(args.trainingdata)                                                     #loading training data set
    print("Importing Prediction data set : "+args.predictiondata)
    dataPred=pd.read_csv(args.predictiondata)                                               #loading prediction data set
